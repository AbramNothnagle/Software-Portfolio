...
if (isset($_POST['submit'])){
    ...
    $id = mysqli_real_escape_string($conn, $_POST['org']);
    ...
    if(!preg_match("/^[a-zA-Z]*$/", $first) || !preg_match("/^[a-zA-Z]*$/", $last)){
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($resultCheck > 0){
                ...
                $sql = "INSERT INTO employees (emp_first, emp_last, emp_email, emp_uid, emp_pwd, emp_org, status) VALUES ('$first','$last','$email','$uid','$hashedPwd','$id','active');";
                mysqli_query($conn, $sql);
                // Let the user know they created the employee
                $_SESSION['employee_account_created'] = 'true';
