    ...
    <div class="main-wrapper">
        ...
        <div class='box-create' style='width:100%; height:120px; background-color:rgb(247, 247, 247)'>
            <div id='top-bar' style='margin-left:20px; margin-buttom:-50px;'>
                ...
                <form method='POST' action=<?php search_employee($conn); ?> >
        ...
        echo "<form method='POST' action='".search_employee($conn)."' >";
        echo "<p style='float:left;'>Search</p>";
        echo "<input type='text' name='employee_email' style='width:100%;height:30px; margin-bottom:50px;'>";
        echo "<button type='submit' name='employee' style='float:left; margin-top:-45px; width: 100px; height: 40px;background-color: rgb(194, 194, 194);font-family: arial;
        font-size: 16px;' >Search</button>";
        echo "</form>";
        //echo "<button type='submit' name='employee' style='float:left; margin-top:-45px; width: 100px; height: 40px;background-color: #f3f3f3' >Search</button>";
        ...
        function search_employee($conn) {
            ...
            if (isset($_POST['employee'])) {
                ...
                echo "<br>e<br>e<br>e<br>" . $org_name;
