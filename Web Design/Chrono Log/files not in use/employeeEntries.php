...
<div id="myModal" class="modal" style='display:none;'>
    <div style='width:55%; margin: 0 auto; height:240px; background-color:#fff; margin-top:10%;'>
        ...
        <div style='height:20px;'>
            <input name='date' id='date' form='edit_entry' style='padding: 0 0 0 4px; float:left; margin-left:20px; margin-top:-15px; height:30px; width: 140px;' type=date>
            <input name='start' value='10:00'id='start' form='edit_entry' style='padding: 0 0 0 4px; float:left; margin-left:20px; margin-top:-15px; height:30px; width: 60px;' type=text>
            <select name='start_diem' form='edit_entry' style='padding: 0 0 0 4px; float:left; margin-left:5px; margin-top:-15px; height:34px; width: 40px;'>
                <option>AM</option>
                <option>PM</option>
            </select>
            <input name='end' value='2:00'id='finish' form='edit_entry' style='padding: 0 0 0 4px; float:left; margin-left:20px; margin-top:-15px; height:30px; width: 60px;' type=text>
            <select name='end_diem'form='edit_entry' style='padding: 0 0 0 4px; float:left; margin-left:5px; margin-top:-15px; height:34px; width: 40px;'>
                <option>AM</option>
        ...
        <div style='height:80px; margin-left:20px;'>
            <textarea form='edit_entry' name='desciption' id='description' style='margin-top:-15px;float:left;width: 658px;height: 60px;'></textarea>
        </div>

        <div style='height:50px; margin-left:20px;'>
            <button form='edit_entry' type='sumbit' id='save_edit' name='project_submit' style='float:right; margin-right:20px;width: 100px;
                margin-top:-15px;
                height: 34px;
                border: none;
        ...
        <form id='edit_entry' method='POST' action='edit_entry_to_employee.php'>
        </form> 
