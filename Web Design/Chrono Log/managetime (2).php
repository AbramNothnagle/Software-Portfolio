                        ...
                        font-size: 16px;'>
                            ...
                            <?php
                                ...
                                while ($row = $result2->fetch_assoc()) {
                                    ...
                                    $sql = "SELECT project_name FROM projects WHERE user_id = '$project_id';";
        ...
        while ($row = $result->fetch_assoc()) {
            if ($row['emp_id']===$emp_id){
                ...
                if ($pid == 0) {
                    ...
                    $sql = "SELECT project_name FROM projects WHERE user_id = '$pid';";
                    $result2 = mysqli_query($conn, $sql);
                ...
                echo "<button value='$tid' class='edit_entry' name='time_id' style=' width: 100px;
                height: 30px;
                position:relative;
                float:right;
                margin-right:20px;
